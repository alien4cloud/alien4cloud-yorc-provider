...
public class YorcAWSLocationConfigurer extends AbstractLocationConfigurer
{
    ...
    public List<LocationResourceTemplate> instances(ILocationResourceAccessor resourceAccessor) {
        LocationResourceGeneratorService.ImageFlavorContext imageContext = resourceGeneratorService.buildContext("yorc.nodes.aws.Image", "id", resourceAccessor);
        LocationResourceGeneratorService.ImageFlavorContext flavorContext = resourceGeneratorService.buildContext("yorc.nodes.aws.InstanceType", "id", resourceAccessor);
