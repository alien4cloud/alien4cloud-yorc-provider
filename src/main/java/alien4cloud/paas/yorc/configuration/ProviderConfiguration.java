...
@Setter
@NoArgsConstructor
@FormProperties({"urlYorc", "insecureTLS", "caCertificate", "clientKey", "clientCertificate", "connectionTimeout", "socketTimeout", "executorThreadPoolSize", "IOThreadCount", "pollingRetryDelay", "connectionMaxPoolSize", "connectionEvictionPeriod", "connectionTtl", "connectionMaxIdleTime", "registryEvictionPerdiod", "registryEntryTtl", "cleanupDeploymentsPeriod" })
